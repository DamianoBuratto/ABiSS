...
# the variable run has been changed to match the one used in gmxpbsa0
...
#	set_variable_default1 "mem" "5GB" "$RUN/REPORTFILE1";
	...
	cd $RUN
	cp ../${INPUT_FILE} ./run${run}_parameters_1.in
